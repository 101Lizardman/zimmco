...
|---|---|---|
| **VEND** | Dispense a beverage (costs 25C each) | ![Vend](assets/readme/1-vend.jpg) |
| **HACK THE MAINFRAME** | Accessing the wiring behind the terminal exposes ports for hacking | ![Hack](assets/readme/2-hack.jpg) |
| **CRACK IT OPEN** | Smash the machine open, risking the stock inside | ![Crack](assets/readme/3-crack.jpg) |
| **TOOLS** | Unjam the lever to open the maintenance compartment. Associated rumor: *"In exchange for a pack of cigarettes, an old shipwright told you how to find the little lever tucked away behind the panel of the coin slot…"* | ![Tools](assets/readme/4-tools.jpg) |
| **PROXIMITY SENSOR** | Wire something into the machine's proxy sensor for use when the machine's in **LOCKDOWN**. Associated rumor: *"Junkers used to setup these bad boys as warning alarms for if any of the less community-minded individuals happened upon the same wreck…"* | ![Proxy](assets/readme/5-proxy.jpg) |
